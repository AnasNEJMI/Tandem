...
import SettingsModifyCurrencyDialog from './settings-modify-currency-dialog'
import SettingsModifySettingsDialog from './settings-modify-settings-dialog'
...
const SettingsPreferencesView = ({setOpenTab, preferences} : SettingsPreferencesProps) => {
