...
const SettingsModifySettingsDialog = ({className, initialOption, options, postRoute,reloadOnlyArray, title, description, disabled} : ModifySettingsProps) => {
...
export default SettingsModifySettingsDialog