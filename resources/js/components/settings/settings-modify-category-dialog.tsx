...
import SettingsDeleteCategoryDialog from './settings-delete-category-dialog'
...
const SettingsModifyCategoryDialog = ({category} : ModifyCategoryProps) => {
  ...
  return (
    <Dialog open = {open} onOpenChange={(open) => {reset(); setOpen(open);}}>
        <div className='flex'>
            ...
            <SettingsDeleteCategoryDialog className='rounded-tr-md rounded-br-md rounded-tl-none rounded-bl-none h-20 bg-white w-20' category={category}/>
        </div>
...
export default SettingsModifyCategoryDialog