...
const StatsSpendingEvolutionFiltersDrawer = ({className, 
                                            spenders,
                                            categories,
                                            selectedCategories,
                                            selectedSpenders,
  ...
  return (
    <Drawer open = {open} onOpenChange = {setOpen}>
        ...
        <DrawerContent className={cn('', className)}>
            <form onSubmit={handleSubmit} className="mx-auto w-full max-w-xl flex flex-col h-full mt-8 px-4">
...
export default StatsSpendingEvolutionFiltersDrawer