...
const GoalsAddGoalSheet = ({className, spenders, categories} : AddGoalSidebarProps) => {
  ...
  return (
    <Sheet open = {open} onOpenChange={setOpen}>
        ...
        <SheetContent side="bottom" className={cn("h-screen overflow-y-auto rounded-t-3xl border-0 shadow-xl  px-6 pb-8", className)}>
...
export default GoalsAddGoalSheet