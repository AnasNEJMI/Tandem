...
const SettingsProfile = ({setOpenTab} : SettingsProfileProps) => {
  return (
    <>
        <div className='relative w-full py-4 px-4'>
            ...
            <span className='absolute font-bold text-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>Profile</span>
        </div>
