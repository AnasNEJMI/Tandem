...
export function ExpensesAddExpenseDrawer({categories, spenders, preferences, open, setOpen} : AddExpenseDrawerProps) {
  ...
  return (
    <Drawer open = {open}  onOpenChange={setOpen}>
      ...
      <DrawerContent className="">
        <form onSubmit={handleSubmit} method="POST" encType="multipart/form-data" className="mx-auto w-full max-w-xl h-full relative px-6">
